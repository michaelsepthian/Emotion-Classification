...
def detection():
    ...
    #inisialisasi emotions untuk dimasukkan ke dalam grafik
    emotions = ['Happy', 'Angry', 'Surprise', 'Sad', 'Fear']
    #konfigurasi dari grafik yang akan dibuat gambar
    ...
    return render_template("index.html", hasil=result, komen=komentar, chart = pie_chart, percent_emotion=percent_emotion)
